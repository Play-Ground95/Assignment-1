public class Task_c {
    public static void main(String[] args) {
        ...
        System.out.printf("%s|%s%s%-5s%s%s%-10s%s%s|%s%s%-5s%s%s%-5s%s%s |%s%s%-12s%s%s | \n",ORANGE,ORANGER,COLOR5,"New",RESET5,COLOR4,"York",RESET4,ORANGE,ORANGER,COLOR5,"New",RESET5,COLOR4,"York",RESET4,ORANGE,ORANGER,COLOR4,"8,336,817",RESET4,ORANGE,ORANGER);
        System.out.printf("%s+%15s+%10s+%12s+%s \n",ORANGE,"---------------","-----------","-------------",ORANGER);
